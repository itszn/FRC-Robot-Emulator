 ...
 */
public class DriverStationOrig implements IInputOutput {
    ...
    private static class DriverStationTask implements Runnable {
        ...
        private DriverStationOrig m_ds;

        DriverStationTask(DriverStationOrig ds) {
            m_ds = ds;
        }
    ...
    private static DriverStationOrig instance = new DriverStationOrig();
   ...
   // private final Object m_semaphore;
     ...
     */
    public static DriverStationOrig getInstance() {
        return DriverStationOrig.instance;
    }
    ...
    public boolean isOperatorControl() {
        return !(m_controlData.autonomous() || m_controlData.testMode());
    }
    ...
    public Dashboard getDashboardPackerHigh() {
        return null;// m_dashboardDefaultHigh;
    }
    ...
    public IDashboard getDashboardPackerInUseHigh() {
        return null;//m_dashboardInUseHigh;
    }
    ...
    public Dashboard getDashboardPackerLow() {
        return null;//m_dashboardDefaultLow;
    }
    ...
    public IDashboard getDashboardPackerInUseLow() {
        return null;//m_dashboardInUseLow;
    }
